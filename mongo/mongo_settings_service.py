...
DISCORD_TO_TELE_BROADCAST_SETTING = "discord_to_tele_broadcast"
...
class SettingsDbService:
    ...
    @staticmethod
    def update_discord_to_tele_broadcast_setting(channel_id: int, value: bool) -> bool:
        return SettingsDbService.update_setting_value(
            channel_id, DISCORD_TO_TELE_BROADCAST_SETTING, value
        )

    @staticmethod
    def get_discord_to_tele_broadcast_setting(channel_id: int) -> bool:
        return SettingsDbService.get_setting_value(
            channel_id, DISCORD_TO_TELE_BROADCAST_SETTING
        )
